...
namespace Eregister.Controllers
{
    public class BlogController : Controller
    {
        ...
        #endregion WallPostsGroups

        #region WallPostsGroupsContent
        [ChildActionOnly]
        public ActionResult WallPostsGroupsContent()
        {
            return PartialView();
        }
        #endregion
        ...
        #region WallComments
        [ChildActionOnly]
        public ActionResult WallComments(string pageId, string sortOrder)
        {
            return PartialView();
        }
        ...
        // moje dla GruopWall
        public IPagedList<BlogViewModel> CreatePagedBlogViewModelForGroup(int? page, string sortOrder, string searchString, string[] searchCategory, string[] searchTag)
        {
            postList.Clear();
        ...
        public ActionResult Post(string sortOrder, string slug)
        {
            ...
            model.GroupDirect = postid.Contains("groupWall") ? postid.Substring(9, 6) : "";
           // if (postid.Contains("groupWall")) model.GroupDirect = postid.Substring(9, 6); //wytnij z url np. groupWall4b2017_2 frazę 452017 (klasa+rok)
            return View(model);
        }
        ...
        public CommentViewModel CreateCommentViewModelForGroup(string pageId, string sortOrder) //zastapic to parametrem w ogolnej metodzie bez'ForGroup'
        {
            CommentViewModel model = new CommentViewModel();
        ...
        public string TimeAgo(DateTime postDate)
        {
            string date = null;
            double dateDiff = 0.0;
            var timeDiff = thisDate - postDate;
            var yearPassed = timeDiff.TotalDays / 365;
            var monthPassed = timeDiff.TotalDays / 30;
            var dayPassed = timeDiff.TotalDays;
            var hourPassed = timeDiff.TotalHours;
